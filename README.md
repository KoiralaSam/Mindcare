...
The public app is deployed as a Vercel-hosted React frontend talking to a Go API and Python ML service running on Railway/Neon. You can try it here: [Live Mindcare app](https://mindcare-alpha-rosy.vercel.app/).
